...
public class 상영관_배치도2 extends JFrame{
//	길: 0, 벽: 1, 도착지: 2
	Data data = null;
	...
	Thread thread;
	public 상영관_배치도2(int u_no, Data data, boolean isFromMain) {
		addWindowListener(new WindowAdapter() {
			@Override
			public void windowClosing(WindowEvent e) {
				if(thread != null) thread.interrupt();
				new Reservation(u_no, Integer.parseInt(data.get(1).toString()), isFromMain);
			}
		});
