...
public class SeatSelect extends CFrame{
	...
	private void setMainPanel() {
		...
		JPanel a = new JPanel(new GridLayout(9, 2, 10, 10));
		a.setBackground(Color.white);
		
		JPanel b = new JPanel(new GridLayout(9, 5, 10, 10));
		b.setBackground(Color.white);
		
		JPanel c = new JPanel(new GridLayout(9, 2, 10, 10));
	...
	public static void main(String[] args) {
		new SeatSelect(Connections.select("SELECT * FROM moviedb.schedule where sc_no = 187;").get(0));
	}
}
